        ...
        <div className="flex flex-col gap-4 pb-10 md:flex-row">
          <button className="flex w-full cursor-default items-center justify-between gap-4 rounded-xl bg-blue-100 px-5 py-4 font-bold text-blue-900 md:w-[50%]">
            <div
              ...
              onClick={() =>
                setNumberOfSneakers((num) => (num > 0 ? num - 1 : 0))
              }
            >
            ...
            <div
              className="cursor-pointer hover:opacity-70"
              onClick={() => setNumberOfSneakers((num) => num + 1)}
            >
              <img src="images/icon-plus.svg" alt="plus" />
            </div>
          </button>
          <button className="flex w-full justify-center gap-4 rounded-xl bg-orange-200 py-4 font-bold text-white hover:bg-orange-200/70">
